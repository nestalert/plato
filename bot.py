...
class IntentChatbot:
    def __init__(self, class_suggestions,intents_file='intents.json',links_file='links.json',professors_file='professors.json',model_file='chatbot_model.pkl'):
    ...
    def predict_intent(self, user_input):
        ...
        predicted_tag = self.model.predict([processed_input])[0]
